        ...
        while True:
            ...
            for row in range(Dynamics.row):
                for col in range(Dynamics.col):
                    ...
                    if curr_state in Dynamics.obstacle_states or curr_state in Dynamics.goal_state or curr_state in Dynamics.gold_state:
                        continue
                    else:
        ...
        for action, probs in probability_values.items():
            ...
            for next_state,prb in probs.items():
                ...
                if(next_state in Dynamics.goal_state):
                    reward = 10
                if(next_state in Dynamics.gold_state):
                    reward = 4.484
...
def main():
        ...
        for row in final_policy:
            ...
            print()
        print("\n")
        print(f"Value of gamma:",Dynamics.gamma)
        print("\n\n")
